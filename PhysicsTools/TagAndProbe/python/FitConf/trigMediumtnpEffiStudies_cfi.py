...
ptBins = cms.PSet(
#    EfficiencyCategoryAndState = cms.vstring("probe_passingHLTEle8","pass"),
...
categories =  cms.PSet(
       # probe_passingHLTEle8 = cms.vstring("probe_passingSomething", "dummy[pass=1,fail=0]"),
	probe_passingHLT = cms.vstring("probe_passingSomething", "dummy[pass=1,fail=0]"),
...
#    Analyzer.Categories.probe_passingHLTEle8=cms.vstring((pred,"dummy[pass=1,fail=0]"))
    Analyzer.Categories.probe_passingHLT=cms.vstring((pred,"dummy[pass=1,fail=0]"))
