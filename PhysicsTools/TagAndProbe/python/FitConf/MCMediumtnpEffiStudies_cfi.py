...
myVariables = cms.PSet(
    ...
    event_met_pfmet= cms.vstring("event met", "0.0", "15", "GeV"),
...
#    UnbinnedVariables = cms.vstring("mass","event_met_pfmet"),
...
ptEtaBins.BinnedVariables = cms.PSet(
    ...
    probe_et = cms.vdouble(10,20,30,40,50,200),
#   probe_abseta = cms.vdouble(0.0,0.8,1.4442,1.556,2.0,2.5),
    probe_abseta = cms.vdouble(0.0,1.4442,1.556,2.5),
...
categories =  cms.PSet(
	probe_passingGsf = cms.vstring("probe_passingSomething", "dummy[pass=1,fail=0]"),
