...
myVariables = cms.PSet(
    ...
    tag_dRTau = cms.vstring("tag_dRTau","0.2","1000",""),
    probe_dRTau= cms.vstring("probe_dRTau","0.2","1000",""),
      )
ptBins = cms.PSet(
    EfficiencyCategoryAndState = cms.vstring("probe_isWPVeto","pass"),
...
categories =  cms.PSet(
        probe_isWPVeto = cms.vstring("probe_passingSomething", "dummy[pass=1,fail=0]"),
...
def ConfigureTPAnalyzer (Analyzer, fileName, pred,binScheme, tree= "fitter_tree"):
    ...
    Analyzer.Categories.probe_isWPVeto=cms.vstring((pred,"dummy[pass=1,fail=0]"))
