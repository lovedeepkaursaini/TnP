...
process.source = cms.Source("PoolSource", 
    fileNames = cms.untracked.vstring(
      $inputFileNames
#'file:/hdfs/store/mc/Summer12_DR53X/TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola/AODSIM/PU_S10_START53_V7A-v1/0000/FE4C2F81-D0E1-E111-9080-0030487E0A2D.root'
...
process.SuperClusterToGsfElectron20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.SuperClusterToGsfElectronM20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.SuperClusterToGsfElectronM25.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdMedium.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdMedium20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdMediumM20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdMediumM25.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdLoose.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdLoose20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdLooseM20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdLooseM25.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdTight.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdTight20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdTightM20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdTightM25.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdVeto.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdVeto20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdVetoM20.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.GsfElectronToIdVetoM25.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.WPMediumToHLTEle17.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.WPLooseToHLTEle17.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.WPMediumToHLTEle8NotEle17.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.WPLooseToHLTEle8NotEle17.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")

process.tree_sequence = cms.Sequence(
#    process.SuperClusterToGsfElectron +
#    process.SuperClusterToGsfElectron20 +
 #   process.SuperClusterToGsfElectronM20 +
 #   process.SuperClusterToGsfElectronM25 +
    process.GsfElectronToIdMedium +
  #  process.GsfElectronToIdMedium20 +
   # process.GsfElectronToIdMediumM25 +
    #process.GsfElectronToIdMediumM20 +
    process.GsfElectronToIdTight +
 #   process.GsfElectronToIdTight20 +
  #  process.GsfElectronToIdTightM25 +
   # process.GsfElectronToIdTightM20 +
    process.GsfElectronToIdLoose +
#    process.GsfElectronToIdLoose20 +
 #   process.GsfElectronToIdLooseM25 +
  #  process.GsfElectronToIdLooseM20 +
    process.GsfElectronToIdVeto +
#    process.GsfElectronToIdVeto20 +
 #   process.GsfElectronToIdVetoM25 +
  #  process.GsfElectronToIdVetoM20 +
    process.WPMediumToHLTEle17 +
    process.WPLooseToHLTEle17 +
    process.WPMediumToHLTEle8NotEle17+
    process.WPLooseToHLTEle8NotEle17
    )    
