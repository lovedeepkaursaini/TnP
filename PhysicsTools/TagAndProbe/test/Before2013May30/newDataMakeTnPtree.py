...
HLTProcessName = "HLT"
OUTPUT_FILE_NAME = "TnPTree_DoubleElecRun2011A.root"
...
'file:/hdfs/store/data/Run2011A/DoubleElectron/AOD/05Aug2011-v1/0000/FE8416EF-15C0-E011-A006-0018F3D096C0.root',
...
process.GsfElectronToIdLoose = cms.EDAnalyzer("TagProbeFitTreeProducer",
    mcTruthCommonStuff, CommonStuffForGsfElectronProbe,
    tagProbePairs = cms.InputTag("tagLooseGsf"),
    arbitration   = cms.string("Random2"),
    flags = cms.PSet(
...
process.GsfElectronToIdVeto = cms.EDAnalyzer("TagProbeFitTreeProducer",
    mcTruthCommonStuff, CommonStuffForGsfElectronProbe,
    tagProbePairs = cms.InputTag("tagVetoGsf"),
    arbitration   = cms.string("Random2"),
    flags = cms.PSet(
