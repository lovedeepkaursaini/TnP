...
process.GsfElectronToIdMediumIDonly.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.IdToWPMedium.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
process.IsoToWPMedium.PUWeightSrc = cms.InputTag("pileupReweightingProducer","pileupWeights")
