...
hltEle8Filter = "hltEle17TightIdLooseIsoEle8TightIdLooseIsoTrackIsoDZ"
...
if isPrompt:
        process.GlobalTag.globaltag = 'GR_P_V41_AN2::All'# for Prompt 2012C_v2
else:
...
if isPrompt:
 ...
 myLumis = LumiList.LumiList(filename = '/afs/hep.wisc.edu/home/anil79/TnP/CMSSW_5_3_5/src/PhysicsTools/TagAndProbe/test/Cert_190456-204567_8TeV_PromptReco_Collisions12_JSON.txt').getCMSSWString().split(',')
...
process.PassingWPTightTAG = cms.EDProducer("ElectronCutBasedCandidateProducer",
   ReferenceElectronCollection = cms.untracked.InputTag("goodElectronsTAG"),
   IsoDepElectron = cms.VInputTag(cms.InputTag('elPFIsoDepositChargedPFIso'),
                                  cms.InputTag('elPFIsoDepositGammaPFIso'),
                                  cms.InputTag('elPFIsoDepositNeutralPFIso')),
   IsoValElectronPF = cms.VInputTag(cms.InputTag('elPFIsoValueCharged03PFIdPFIso'),
...
#meri bari
process.PassingEle17Mass50HLTTight = cms.EDProducer("trgMatchedGsfElectronProducer",
...
process.PassingEle17Mass50HLTLoose = cms.EDProducer("trgMatchedGsfElectronProducer",
...
process.PassingEle17Mass50HLTVeto = cms.EDProducer("trgMatchedGsfElectronProducer",
...
process.tagSC = cms.EDProducer("CandViewShallowCloneCombiner",
    decay = cms.string("PassingEle17Mass50HLT goodSuperClustersClean"), # charge conjugate states are implied
