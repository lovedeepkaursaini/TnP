...
fileName = "mrgd_TnPTree_DYToEEPOWHEGFall11_June13"
#fileName = "mrgd_TnPTree_DoubleElec2011AB_June10"
...
def SetTreeAnalyzer( anlzr, fileName, pred, ptBin, etaBin):
	...
	binVar.BinnedVariables.probe_gsfEle_et = ptBin#cms.vdouble(20,30)
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/anil79/VETO/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+".root"
