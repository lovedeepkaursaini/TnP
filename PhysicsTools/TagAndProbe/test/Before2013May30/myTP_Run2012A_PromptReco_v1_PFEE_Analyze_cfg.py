...
isMC = False
#InputFileName = "TnPTree_DoubleElecRun2012A.root"
InputFileName = "/hdfs/store/user/anil79/2011mrgdDoubleElectronRun2011AB.root"
#InputFileName = "/hdfs/store/user/anil79/mrgdTightIDTnPTree_DoubleElecRun2012AB.root"
#InputFileName = "/hdfs/store/user/anil79/mrgdLooseIDTnPTree_DoubleElecRun2012AB.root"
OutputFilePrefix = "/scratch/anil79/lvefficiency-Run2011-MEDIUM"
#OutputFilePrefix = "/scratch/anil79/lvefficiency-Run2012A-TIGHT"
#OutputFilePrefix = "/scratch/anil79/lvefficiency-Run2012A-LOOSE"
...
"BreitWigner::physicsShape(mass,m0[91.1876,80,100],fwhm[2.495])",  #replace with floating + constriant later?
         ...
         "FCONV::signal(mass,physicsShape,resolution)",
            "Exponential::backgroundPass(mass, lp[-0.0055, -10, -0.005])",
            "Exponential::backgroundFail(mass, lf[-0.0055, -10, -0.005])",
...
#    "FCONV::signal(mass, signalPhy, resolution)",
...
#   "Gaussian::signal1(mass, mean[91.2, 89.0, 93.0], sigma[2.3, 0.5, 10.0])",
...
process.SCToGsfElectron.binnedFit = cms.bool(True)
process.SCToGsfElectron.binsForFit = cms.uint32(40)
#fit nai ho reha
