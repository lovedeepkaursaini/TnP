...
ratio_max = 2.
ratio_min = 0.1
ratio_fraction = 0.15  # Fraction of the canvas that bottom plot occupies
...
area_normalized_title = 'area normalised'
...
#latex.DrawLatex(0.94,0.96,"4.597 fb^{-1}  at   #sqrt{s} = 7 TeV")
#latex.SetTextAlign(11)
