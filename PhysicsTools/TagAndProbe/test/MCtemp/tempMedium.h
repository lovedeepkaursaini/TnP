...
#ifdef tempMedium_cxx
tempMedium::tempMedium(TTree *tree)
{
...
//"/hdfs/store/user/kaur/mrgdTnPTreeElec_DYToEE_M-20_CT10_TuneZ2star_v2_8TeV-powheg-pythia6_Aug27.root"
         ...
         f->cd(
"/hdfs/store/user/kaur/mrgdTnPTreeElec_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraphSummer12_DR53X-PU_S10_START53_V7A-v1_Aug27.root:/GsfElectronToIdMedium"
...
tempMedium::~tempMedium()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tempMedium::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tempMedium::LoadTree(Long64_t entry)
{
...
void tempMedium::Init(TTree *tree)
{
...
void tempMedium::Show(Long64_t entry)
{
...
Int_t tempMedium::Cut(Long64_t entry)
{
