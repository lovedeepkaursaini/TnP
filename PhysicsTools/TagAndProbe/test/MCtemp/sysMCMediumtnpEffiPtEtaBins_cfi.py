...
fileName = "mrgdTnPTreeElec_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraphSummer12_DR53X-PU_S10_START53_V7A-v1_Nov24"
...
#etabins = (0.0,0.8,1.4442)
#etabins = (1.4442,1.556,2.0,2.5)
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/anil79/sys2012DATA/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+".root"
