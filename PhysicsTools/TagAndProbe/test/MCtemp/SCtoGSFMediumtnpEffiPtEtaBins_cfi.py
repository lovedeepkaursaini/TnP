...
fileName = "mrgdTnPTreeElec_DoubleElectronRun2012_SConly"
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/kaur/sctogsf2012DATA/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+"SConly.root"
