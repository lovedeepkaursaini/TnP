...
#ifndef Print4IlyaData_h
#define Print4IlyaData_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class Print4IlyaData {
public :
...
//   TBranch        *b_probe_isWPMediumISOonly;   //!
   ...
   Print4IlyaData(TTree *tree=0);
   virtual ~Print4IlyaData();
...
#ifdef Print4IlyaData_cxx
Print4IlyaData::Print4IlyaData(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(
"/hdfs/store/user/kaur/mrgdTnPTreeElec_DoubleElectronRun2012_June10.root"
//#"/hdfs/store/user/kaur/mrgdTnPTreeElec_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraphSummer12_DR53X-PU_S10_START53_V7A-v1_Aug27.root"
//"hdfs/store/user/kaur/mrgdTnPTreeElec_DYToEE_M-20_CT10_TuneZ2star_v2_8TeV-powheg-pythia6_Aug27.root"
);
      if (!f) {
         f = new TFile(
"/hdfs/store/user/kaur/mrgdTnPTreeElec_DoubleElectronRun2012_June10.root"
//"/hdfs/store/user/kaur/mrgdTnPTreeElec_DYToEE_M-20_CT10_TuneZ2star_v2_8TeV-powheg-pythia6_Aug27.root"
         ...
         f->cd(
"/hdfs/store/user/kaur/mrgdTnPTreeElec_DoubleElectronRun2012_June10.root:/GsfElectronToIdMedium"
//"/hdfs/store/user/kaur/mrgdTnPTreeElec_DYToEE_M-20_CT10_TuneZ2star_v2_8TeV-powheg-pythia6_Aug27.root:/GsfElectronToIdMedium"
);
      }
...
Print4IlyaData::~Print4IlyaData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Print4IlyaData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Print4IlyaData::LoadTree(Long64_t entry)
{
...
void Print4IlyaData::Init(TTree *tree)
{
...
void Print4IlyaData::Show(Long64_t entry)
{
...
Int_t Print4IlyaData::Cut(Long64_t entry)
{
...
#endif // #ifdef Print4IlyaData_cxx
