...
fileName = "mrgdTnPTreeElec_DoubleElectronRun2012_Jan13"
stage = "WPMediumToHLTEle17"
pred = "probe_passingHLT"

import os
#os.system("rm ZeeGenLevel.root")
#os.system("ln -s Templates/"+stage+".root ./ZeeGenLevel.root")

from PhysicsTools.TagAndProbe.FitConf.trigMediumtnpEffiStudies_cfi import *
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/kaur/trig2012DATA/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+".root"
