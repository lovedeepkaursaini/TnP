...
from PhysicsTools.TagAndProbe.FitConf.LoosetnpEffiStudies_cfi import *
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/anil79/2012DATAnewEASYS/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+"poly4.root"
