...
// Sun Jun 10 14:59:05 2012 by ROOT version 5.27/06b
// from TTree fitter_tree/fitter_tree
// found on file: /hdfs/store/user/anil79/2011mrgdTnPTree_DYToEEFall11POWHEG.root
//////////////////////////////////////////////////////////
...
#ifdef tempMC_cxx
tempMC::tempMC(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/anil79/2011mrgdTnPTree_DYToEEFall11POWHEG.root");
      if (!f) {
         f = new TFile("/hdfs/store/user/anil79/2011mrgdTnPTree_DYToEEFall11POWHEG.root");
         f->cd("/hdfs/store/user/anil79/2011mrgdTnPTree_DYToEEFall11POWHEG.root:/GsfElectronToIdLoose");
      }
...
Int_t tempMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tempMC::LoadTree(Long64_t entry)
{
...
void tempMC::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("probe_isWPLoose", &probe_isWPLoose, &b_probe_isWPLoose);
...
void tempMC::Show(Long64_t entry)
{
...
Int_t tempMC::Cut(Long64_t entry)
{
