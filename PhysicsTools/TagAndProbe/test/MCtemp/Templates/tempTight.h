...
#ifdef tempTight_cxx
tempTight::tempTight(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      if (!f) {
         ...
         f->cd("/hdfs/store/user/kaur/mrgdTnPTreeElec_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraphSummer12_DR53X-PU_S10_START53_V7A-v1_Sep5.root:/GsfElectronToIdTight");
      }
...
Int_t tempTight::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tempTight::LoadTree(Long64_t entry)
{
...
void tempTight::Init(TTree *tree)
{
...
void tempTight::Show(Long64_t entry)
{
...
Int_t tempTight::Cut(Long64_t entry)
{
