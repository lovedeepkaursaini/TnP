...
import os
from PhysicsTools.TagAndProbe.FitConf.PUMediumtnpEffiStudies_cfi import *
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/kaur/Summer12newEA/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+"rmtau.root"
