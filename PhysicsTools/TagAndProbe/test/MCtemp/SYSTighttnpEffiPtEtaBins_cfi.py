...
from PhysicsTools.TagAndProbe.FitConf.TighttnpEffiStudies_cfi import *
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/anil79/2012DATAnewEASYS/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+"poly2.root"
