...
fileName = "mrgdTnPTreeElec_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraphSummer12_DR53X-PU_S10_START53_V7A-v1_Jan13"
...
from PhysicsTools.TagAndProbe.FitConf.nPVMediumtnpEffiStudies_cfi import *
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/kaur/nPV/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+".root"
