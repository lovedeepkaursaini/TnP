...
fileName = "mrgdTnPTreeElec_DYJetsToLLmadgraphSummer12_DR53X_SConly"
stage = "SuperClusterToGsfElectron"
pred = "probe_passingGsf"

import os
#os.system("rm ZeeGenLevel.root")
#os.system("ln -s Templates/"+stage+".root ./ZeeGenLevel.root")

from PhysicsTools.TagAndProbe.FitConf.MCMediumtnpEffiStudies_cfi import *
...
def SetTreeAnalyzer( anlzr, fileName, pred, ptBin, etaBin):
	...
	binVar.BinnedVariables.probe_et = ptBin#cms.vdouble(20,30)
	binVar.BinnedVariables.probe_abseta =etaBin#cms.vdouble(0,1.44)
...
for anlzr in analyzers:
	...
	getattr(process,subProcess).OutputFileName="/scratch/kaur/sctogsfSummer12/"+subProcess+"_"+fileName+"_PtEtaBins_"+pred+"_"+treeName+".root"
