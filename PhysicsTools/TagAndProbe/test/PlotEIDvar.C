...
void PlotEIDvar::Loop()
{
   ...
   float eta[6] = {0.0,0.8,1.4442,1.566,2.0,2.5};
    TFile* file  = new TFile("PlotTnMediumIDVarMC.root","RECREATE");
    ...
    TH1D* eleEB_iso_ch=new TH1D("eleEB_iso_ch","eleEB_iso_ch",100,0.,0.2);
    TH1D* eleEB_iso_em=new TH1D("eleEB_iso_em","eleEB_iso_em",100,0.,0.2);
    TH1D* eleEB_iso_nh=new TH1D("eleEB_iso_nh","eleEB_iso_nh",100,0.,0.2);
    ...
    TH1D* eleEE_iso_ch=new TH1D("eleEE_iso_ch","eleEE_iso_ch",100,0.,0.2);
    TH1D* eleEE_iso_em=new TH1D("eleEE_iso_em","eleEE_iso_em",100,0.,0.2);
    TH1D* eleEE_iso_nh=new TH1D("eleEE_iso_nh","eleEE_iso_nh",100,0.,0.2);
    ...
    /*TH1D* eleEB_dEtaIn=new TH1D("eleEB_dEtaIn","eleEB_dEtaIn",100,-0.08,0.08);
    TH1D* eleEB_dPhiIn=new TH1D("eleEB_dPhiIn","eleEB_dPhiIn",100,-0.8,0.8);
    TH1D* eleEB_sigmaIEtaIEta=new TH1D("eleEB_sigmaIEtaIEta","eleEB_sigmaIEtaIEta",100,0,0.08);
    TH1D* eleEB_hoe=new TH1D("eleEB_hoe","eleEB_hoe",100,0.,1.);
    TH1D* eleEB_d0vtx=new TH1D("eleEB_d0vtx","eleEB_d0vtx",100,-0.1,0.1);
    TH1D* eleEB_dzvtx=new TH1D("eleEB_dzvtx","eleEB_dzvtx",100,-1.,1.);
    TH1D* eleEB_ooemoop=new TH1D("eleEB_ooemoop","eleEB_ooemoop",100,0.,0.1);
    TH1D* eleEB_iso=new TH1D("eleEB_iso","eleEB_iso",100,0.0,2.);
    TH1D* eleEB_iso_ch=new TH1D("eleEB_iso_ch","eleEB_iso_ch",100,0.,2.0);
    TH1D* eleEB_iso_em=new TH1D("eleEB_iso_em","eleEB_iso_em",100,0.,2.0);
    TH1D* eleEB_iso_nh=new TH1D("eleEB_iso_nh","eleEB_iso_nh",100,0.,2.0);
    TH1D* eleEE_dEtaIn=new TH1D("eleEE_dEtaIn","eleEE_dEtaIn",100,-0.08,0.08);
    TH1D* eleEE_dPhiIn=new TH1D("eleEE_dPhiIn","eleEE_dPhiIn",100,-0.8,0.8);
    TH1D* eleEE_sigmaIEtaIEta=new TH1D("eleEE_sigmaIEtaIEta","eleEE_sigmaIEtaIEta",100,0,0.08);
    TH1D* eleEE_hoe=new TH1D("eleEE_hoe","eleEE_hoe",100,0.,1.);
    TH1D* eleEE_d0vtx=new TH1D("eleEE_d0vtx","eleEE_d0vtx",100,-0.1,0.1);
    TH1D* eleEE_dzvtx=new TH1D("eleEE_dzvtx","eleEE_dzvtx",100,-1.,1.);
    TH1D* eleEE_ooemoop=new TH1D("eleEE_ooemoop","eleEE_ooemoop",100,0.,0.1);
    TH1D* eleEE_iso=new TH1D("eleEE_iso","eleEE_iso",100,0.0,2.);
    TH1D* eleEE_iso_ch=new TH1D("eleEE_iso_ch","eleEE_iso_ch",100,0.,2.0);
    TH1D* eleEE_iso_em=new TH1D("eleEE_iso_em","eleEE_iso_em",100,0.,2.0);
    TH1D* eleEE_iso_nh=new TH1D("eleEE_iso_nh","eleEE_iso_nh",100,0.,2.0);
*/
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //double PUweight=1;
//      PUweight=PUweight*2.25;
      if(!(probe_sc_abseta<=1.4442 || (probe_sc_abseta>=1.566 && probe_sc_abseta<=2.5)))continue;
//        if(!( mass > 85 && mass <97 ) )continue;
      if(!( mcTrue && mass > 85 && mass <97 && tag_dRTau >0.2 && probe_dRTau > 0.2) )continue;
	  ...
	  eleEtaAll->Fill(probe_sc_eta,PUweight);
      }
	  ...
	  if(probe_sc_abseta<=1.4442)
	    {
	      ...
	      eleEB_iso_ch->Fill(probe_iso_ch/probe_gsfEle_pt,PUweight);
	      eleEB_iso_em->Fill(probe_iso_em/probe_gsfEle_pt,PUweight);
	      eleEB_iso_nh->Fill(probe_iso_nh/probe_gsfEle_pt,PUweight);
	    }
	  else if(probe_sc_abseta>=1.566 && probe_sc_abseta<=2.5)
	    {
	      eleEE_iso->Fill(probe_iso,PUweight);
	      eleEE_iso_ch->Fill(probe_iso_ch/probe_gsfEle_pt,PUweight);
	      eleEE_iso_em->Fill(probe_iso_em/probe_gsfEle_pt,PUweight);
	      eleEE_iso_nh->Fill(probe_iso_nh/probe_gsfEle_pt,PUweight);
	    }
	}
   }
   file->Write();
